    ...
    public function run(): void
    {
        $datas = [
            ...
            [
                ...
                'body1' => '<p><strong>Bulukumba –</strong> Anggota DPRD Kabupaten Bulukumba dari Fraksi Partai Keadilan Sejahtera (PKS), <strong>Dr. Supriadi</strong>, meminta Perum Bulog Bulukumba agar tidak mengabaikan penyerapan jagung dari petani lokal. Hal ini disampaikannya dalam rapat dengar pendapat antara <strong>Komisi II DPRD Bulukumba</strong> dan pihak Bulog yang berlangsung di Gedung DPRD setempat.</p> <p>Supriadi menegaskan bahwa sikap Bulog yang hingga kini belum melakukan pembelian jagung sangat mengecewakan, apalagi saat ini sejumlah wilayah, khususnya di bagian timur Bulukumba, tengah memasuki masa panen raya.</p> <blockquote> <p>“Jagung jangan dinomorduakan. Petani sedang panen. Kalau Bulog mengabaikan jagung, berarti mengabaikan instruksi negara,” ujar Supriadi dengan nada tegas.</p> </blockquote> <p>Diketahui, pemerintah pusat telah menetapkan <strong>Harga Pembelian Pemerintah (HPP)</strong> untuk komoditas jagung di tingkat petani sebesar <strong>Rp5.500 per kilogram</strong>, melalui <strong>Keputusan Kepala Badan Pangan Nasional Nomor 18 Tahun 2025</strong>. Kebijakan ini bertujuan untuk menjaga stabilitas harga, memperkuat stok <strong>Cadangan Jagung Pemerintah (CJP)</strong>, serta meningkatkan kesejahteraan petani.</p>',
                'body2' => '<p>Namun demikian, hingga saat ini belum ada realisasi penyerapan jagung oleh Bulog Bulukumba. Kepala Bulog Bulukumba, <strong>Farid Nur</strong>, mengakui bahwa pihaknya masih memprioritaskan pengadaan gabah, bukan jagung.</p><blockquote><p>“Kami belum menyerap jagung sama sekali. Fokus kami saat ini masih pada pengadaan gabah,” terang Farid saat menjawab pertanyaan para anggota dewan.</p></blockquote><p>Sikap ini menjadi sorotan mengingat saat ini <strong>harga jagung di tingkat petani jatuh drastis</strong>, hanya berkisar <strong>Rp2.500 per kilogram</strong> — jauh di bawah HPP yang ditetapkan. Sementara itu, <strong>luas lahan jagung di Bulukumba mencapai 13 ribu hektare</strong>, dengan total produksi diperkirakan melebihi <strong>70 ribu ton</strong>, sebagaimana disampaikan oleh <strong>Kepala Dinas Pertanian Bulukumba, Muhammad Tayeb</strong>.</p><p>Kondisi ini memperkuat desakan agar Bulog segera bertindak dalam menyerap jagung lokal sebagai bentuk dukungan terhadap upaya peningkatan kesejahteraan petani dan ketahanan pangan daerah.</p>',
                'picture1' => 'image/anggota-dprd-pks-minta-bulog-bulukumba-ikut-serap-hasil-panenn-jagung-petani.jpg',
                'picture2' => 'default.png',
                'picture3' => 'default.png',
                'visit' => 50,
            ],
