                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    <div>
                        ...
                        <p className="mb-4 text-gray-400">
                            Partai Keadilan Sejahtera (PKS) Bulukumba berkomitmen untuk membangun Bulukumba yang adil, makmur, dan sejahtera.
                        </p>
                        <div className="flex space-x-4">
                            {[
                                ...
                                <motion.div key={index} whileHover={{ y: -5, scale: 1.2 }} transition={{ type: 'spring', stiffness: 300 }}>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {[
                                ...
                                { name: 'PKS Sulawesi Selatan', href: 'https://sulsel.pks.id/' },
                                { name: 'DPRD Bulukumba', href: 'https://dprd.bulukumbakab.go.id' },
                                { name: 'Pemkab Bulukumba', href: 'https://bulukumbakab.go.id' },
                            ].map((link, index) => (
                                <motion.li key={index} whileHover={{ x: 5 }} transition={{ duration: 0.2 }}>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <motion.li className="flex items-center space-x-3" whileHover={{ x: 5 }} transition={{ duration: 0.2 }}>
                                ...
                                <span className="text-gray-400">+62 853-4362-2871</span>
                            </motion.li>
                            <motion.li className="flex items-center space-x-3" whileHover={{ x: 5 }} transition={{ duration: 0.2 }}>
                                <Mail size={20} className="flex-shrink-0 text-[#F47C20]" />
                                <span className="text-gray-400">humas@bulukumba.pks.id</span>
                            </motion.li>
                        </ul>
                    </div>
                </div>
